...
public class AddressDaoImpl implements AddressDao {
	...
	public void deletebyid(Integer a_id) {
		jdbcTemplate.update("delete from Address where a_id=?", new Object[] { a_id });
	...
	public Address findbyid(Integer a_id) {
		return (Address) jdbcTemplate.queryForObject("select *from Address where a_id=?", new Object[] { a_id },
